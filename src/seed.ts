  ...
  try {
    ...
    const projectList = [
      ...
      },
      {
        ...
        techStack: ["Node.js", "Express", "MySQL", "TypeScript"],
        ...
        systemDesign: "Express.js with middleware architecture for authentication, rate limiting, request validation using Zod, and structured error responses. MySQL for persistence with Drizzle ORM.",
